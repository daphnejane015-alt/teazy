...
<div class="bg-white rounded shadow p-6 max-w-2xl">
    <form action="{{ route('admin.teas.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        ...
        <div>
            ...
            <textarea name="health_benefit" rows="4" class="mt-1 block w-full border-gray-300 rounded" maxlength="1000">{{ old('health_benefit') }}</textarea>
        ...
        <div class="bg-gray-50 rounded-lg p-4 space-y-4">
            ...
            <div>
                ...
                <input type="url" name="shopee_link" value="{{ old('shopee_link') }}" class="mt-1 block w-full border-gray-300 rounded" placeholder="https://shopee.com.my/product-link or leave blank for search">
            ...
            <div>
                ...
                <input type="url" name="lazada_link" value="{{ old('lazada_link') }}" class="mt-1 block w-full border-gray-300 rounded" placeholder="https://lazada.com.my/product-link or leave blank for search">
